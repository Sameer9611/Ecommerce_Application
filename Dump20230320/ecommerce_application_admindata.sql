...
CREATE TABLE `admindata` (
  `Adminusername` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `Adminpasswordsafe` varchar(30) DEFAULT NULL,
...
INSERT INTO `admindata` VALUES ('Admin1','Admin@1'),('Admin2','Admin@2');
