...
public class User_Login_Features implements Interface_User_Login_Features{
	...
	public void addTocart() {
		...
		System.out.println("---*---*---*---*---*---*---*---*---*---*---*---*---*---*---*---*---*---*---*");
		System.out.println("NOTE:While Adding Same product Again to Cart,Previously added Product Quantity gets Overridden");
		System.out.println("---*---*---*---*---*---*---*---*---*---*---*---*---*---*---*---*---*---*---*");
		...
		String input_option =sc1.next();
			...
			if(input_option.equals("1")) {/*if 1 enters login page*/
				...
				addTocart();/*loop till user enter 1 or 2*/
				//sc1.close();	
		}
